...
def create_viewer():
    ...
    if test_analyze:
        ...
        example_points_layer = os.path.join(path, "../../example_data/example_features.txt")
        ...
        example_tracks_layer = os.path.join(path, "../../example_data/example_linked_features_filt.txt")
        ...
        example_labels_layer = os.path.join(path, "../../example_data/example_labeled_mask.tif")
